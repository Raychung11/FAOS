...
const FIELDS = {
  products: [['sku','SKU','text'],['barcode','Barcode','text'],['name','Name','text'],['uom','UOM','text'],
    ...
    ['shelf_life_days','Shelf Life (days)','number'],['tax_code_id','Tax Code ID','number'],
    ['is_sellable','Sellable','bool'],['is_active','Active','bool']],
  tax_codes: [['code','Code','text'],['name','Name','text'],
    ['tax_type','Type','select',['service','sales','zero','exempt']],
    ['rate','Rate %','number'],['is_active','Active','bool']],
