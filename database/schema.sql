...
-- ---------------------------------------------------------------------
-- Entrepreneur business data model
--   A client (the entrepreneur) owns one or more companies; each
--   company has shareholders / directors / beneficiaries and dated
--   business-financial snapshots. Mirrors the migrate_business.sql
--   extract so a fresh install and an additive migration agree.
-- ---------------------------------------------------------------------
