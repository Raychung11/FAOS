...
<div class="grid cols-4" style="margin-bottom:18px">
  ...
  <div class="stat accent"><div class="stat-label">Reports Used</div>
    ...
    <div class="stat-foot"><?= (int) $usage['proposal'] ?> proposal · <?= (int) $usage['capability'] ?> capability · <?= (int) $usage['tax'] ?> tax · <?= (int) $usage['wealth'] ?> wealth · <?= (int) $usage['risk'] ?> risk · <?= (int) $usage['valuation'] ?> valuation · <?= (int) $usage['succession'] ?> succession</div></div>
